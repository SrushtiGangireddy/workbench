...
public class DataBrowserController implements DataBrowserApiDelegate {
     ...
     * client representation (generated by Swagger).
     */
    private static final Function<Object[],org.pmiops.workbench.model.SurveyQuestion>
            TO_CLIENT_SURVEYQUESTION=
            new Function<Object[], SurveyQuestion>() {
                @Override
                public org.pmiops.workbench.model.SurveyQuestion apply(Object[] o) {
                    return new org.pmiops.workbench.model.SurveyQuestion()
                            .questionConceptId(((String)o[0]))
                            .questionValue(((String)o[1]))
    ...
    public ResponseEntity<SurveyResult> getSurveyResults(Long surveyConceptId,Long analysisId) {
        ...
        HashMap<String,SurveyQuestion> surveyQuestionAnswers=new HashMap<String,SurveyQuestion>();


        for(Object[] q:questions){
          SurveyQuestion que=TO_CLIENT_SURVEYQUESTION.apply(q);
          surveyQuestionAnswers.put((String)q[0],que);
        }
        ...
        for(AchillesResult ar:achillesresults){
            ...
            if(surveyQuestionAnswers.containsKey(questionConceptId)){
                List<SurveyAnswer> answers=surveyQuestionAnswers.get(questionConceptId).getAnswers();
                if(!answers.isEmpty()){
        ...
        resp.setQuestions(new ArrayList<SurveyQuestion>(surveyQuestionAnswers.values()));
